...
public static int makeBid()
{
 int tokens1 = 100;
    ...
    System.out.println("You currently have red player" + tokens1 + "tokens"
...
public static int makeBid2()
{
    int tokens2 = 100;
    
    System.out.println("You currently have yellow" + tokens2 + "tokens"
            + "How much do you want to bid?");
